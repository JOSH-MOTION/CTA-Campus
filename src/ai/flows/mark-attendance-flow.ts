 ...
 *
 * - markAttendanceFlow - A function that handles attendance and point awarding.
 * - MarkAttendanceFlowInput - The input type for the markAttendanceFlow function.
 * - MarkAttendanceFlowOutput - The return type for the markAttendanceFlow function.
 */
